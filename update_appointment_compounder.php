...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare("UPDATE appointment SET serial_no=?, appointment_date=?, appointment_start_time=?, appointment_end_time=?, status=?, remark=? WHERE appointment_ID=?");
    $stmt->bind_param("isssssi", $serial_no, $appointment_date, $start_time, $end_time, $status, $remark, $appointment_ID);
